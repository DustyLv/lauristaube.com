...
// .wrangler/tmp/pages-ooN3Zf/functionsWorker-0.29422758248439673.mjs
...
var b64urlToBytes = /* @__PURE__ */ __name2((s) => Uint8Array.from(atob(s.replace(/-/g, "+").replace(/_/g, "/")), (c) => c.charCodeAt(0)), "b64urlToBytes");
var b64urlToJson = /* @__PURE__ */ __name2((s) => JSON.parse(new TextDecoder().decode(b64urlToBytes(s))), "b64urlToJson");
...
__name2(verifyAccess, "verifyAccess");
...
// .wrangler/tmp/bundle-q5kg93/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-q5kg93/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.29422758248439673.js.map
